...
public class QuizActivity extends ActionBarActivity {
    ...
    private static String url = "http://192.168.0.87/udj1/images/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // correct answer
                    ScoreString = correctAnswerForQuestion * 100 / quizCount;
                    ...
                    // failed question
                    ScoreString = correctAnswerForQuestion + 0;
                    ScoreString = 0;
                    System.out.println(correctAnswerForQuestion);
                    currentQuizQuestion++;
    ...
    private class AsyncJsonObject extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            HttpPost httpPost = new HttpPost("http://192.168.0.87/udj1/quiz.php");
